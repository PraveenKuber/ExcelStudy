...
<%
 ...
 /*   stringBuilder.append("<div class=\"draggable paragraph position-2\" data-input=\"2\">A logical candidate for such a species is the chimpanzee, which shares 98.4% of the human genetic code.</div>");
    stringBuilder.append("<div class=\"draggable paragraph position-3\" data-input=\"3\">Chimpanzees cannot speak because, unlike humans, their vocal cords are located higher in their throats and cannot be controlled as well as human vocal cords.their vocal cords are located higher in their throats and cannot be controlled as well as human vocal cords their vocal cords are located higher in their throats and cannot be controlled as well as human vocal cords</div>");
    stringBuilder.append("<div class=\"draggable paragraph position-4\" data-input=\"4\">It does not follow from their lack of speech, however, that chimpanzees are incapable of language</div>");
    stringBuilder.append("<div class=\"draggable paragraph position-5\" data-input=\"5\">rhaps they can acquire grammar and speak if they could only use grammar some way other than with a voice.</div>");
   */
    stringBuilder.append("</div>");
    ...
    stringBuilder.append("</div>");
         ...
         /*Pagination div*/
    stringBuilder.append("<div class=\"ra-rop-pagination-div\">");
    stringBuilder.append("<div id=\"cp-style-div\" class=\"ra-rop-pagination\">");
    stringBuilder.append("<div id=\"cp-style\"  class=\"ra-rop-previous\" style=\"visibility: hidden\" data-page=\"previous\" data-page-id=\"2\">Previous</div>");
    for(int i=1;i<=5;i++){
        if(i==1){
            stringBuilder.append("<div id=\"cp-style\" data-page-number="+i+" class=\"ra-rop-"+i+" active ra-rop-common-pagination\">"+i+"</div>");
        }else{
            stringBuilder.append("<div id=\"cp-style\" data-page-number="+i+" class=\"ra-rop-"+i+" ra-rop-common-pagination\">"+i+"</div>");
        }

    }
    stringBuilder.append("<div id=\"cp-style\" class=\"ra-rop-next\" data-page=\"next\" data-page-id=\"2\">Next</div>");
    stringBuilder.append("</div>");
    stringBuilder.append("</div>");
    /*End*/
