...
demo = {
    ...
    showSwal: function(type){
        ...
        /* *************************** for bplm  ************** */
        showSwal1: function(type,text,title){
        ...
        if(type == 'basic'){
            ...
            swal({
                    title: title,
                    html: '<div class="form-group">' +
                          '<input id="input-field" type="text" class="form-control" required />' +
                          '</div>',
                    showCancelButton: true,
                    confirmButtonClass: 'btn btn-success btn-fill',
                    cancelButtonClass: 'btn btn-danger btn-fill',
                    ...
                    //var Myval=$('#input-field').val();
                    swal({

                        html: //$('#input-field').val()+
                              '<iframe frameborder="0" src="../common/btCommonApproveSignature.jsp?comments='+$('#input-field').val()+'"/>',
            ...
            } // sessionStorage.setItem("comment",Myval);
        },
        ...
        $(document).ready(function(){
            ...
            $('#wizardCard').bootstrapWizard({
                ...
                onTabShow: function(tab, navigation, index) {
					...
					//alert ("hi current "+$current+" total "+$total);
...
//          format: 'H:mm',    // use this format if you want the 24hours timepicker
	...
	showNotification: function(from, align, mesg, color){
        ...
        //For BPLM - Bhaskar
        showNotification2: function(from, align, mesg, color){
    	//color = Math.floor((Math.random() * 4) + 1);
        ...
        showNotification3: function(from, align, mesg, color){
    	//color = Math.floor((Math.random() * 4) + 1);
        ...
        showNotification4: function(from, align, mesg, color, time){
    	//color = Math.floor((Math.random() * 4) + 1);
