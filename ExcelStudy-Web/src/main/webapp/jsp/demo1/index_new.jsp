<html>
  ...
  <%--  <h1>Francium Voice</h1>
    ...
    <div class="recordingArea">
        <div class="button recordButton" id="recordVoice" data-number-of-seconds="10">Record For 10 Seconds</div>
        <a class="button recordButton" id="recordFor5">Record For  5 Seconds</a>
      <a class="button recordButton" id="recordForX" data-number-of-seconds="10">Record For x Seconds</a>
    ...
    <div>
      ...
      &lt;%&ndash;<a class="button disabled one" id="base64">Base64 URL</a>
      <a class="button disabled one" id="save">Upload to Server</a>&ndash;%&gt;
		</div>--%>
    <div data-type="mp3">
      <p>MP3 Controls:</p>
      <a class="button disabled one" id="play">Play</a>
